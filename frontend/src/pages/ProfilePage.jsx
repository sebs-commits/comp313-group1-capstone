  ...
  return (
    <Layout>
      <div className="flex flex-col gap-7 max-w-2xl">
        ...
        {/* Form Card */}
        <div className="rounded-xl bg-[var(--bg-primary)] border border-[var(--border)] overflow-hidden" style={{ marginLeft: '14px' }}>
          ...
          {loading ? (
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5 px-8 py-6">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                />
                <p className="text-[12px] text-[var(--text-muted)]">Email is managed by your account and cannot be changed here.</p>
              </div>
